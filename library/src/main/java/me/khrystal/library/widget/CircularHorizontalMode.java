...
public class CircularHorizontalMode implements ItemViewMode {
    ...
    private int mCircleOffset = 550;
    private float mDegToRad = 1.0f / 140.0f * (float) Math.PI;
    private float mScalingRatio = 0.00001f;
    private float mTranslationRatio = 0.10f;
