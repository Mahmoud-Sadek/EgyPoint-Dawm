...
import com.sadek.dawemapp.adapter.CartItemCompleteAdatpter;
...
public class CartDetailsCompleteFragment extends BottomSheetDialogFragment {
    ...
    CartItemCompleteAdatpter cartItemAdatpter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_cart_details_complete, container, false);
    }
    ...
    private void initUI() {
        ...
        cartItemAdatpter = new CartItemCompleteAdatpter(resturantResponseList, getContext());
